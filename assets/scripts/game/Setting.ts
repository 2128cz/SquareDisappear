...
export default class Setting {
    ...
    public static get Cube_width(): number { return 15; }
    public static get Cube_Height(): number { return 30; }
    // 设定参数定义
    protected static _GameSpeed: number = 500;
    ...
    protected static _CubeSpeed: number = 600;
